...
<html>
 ...
 <title>Receptionist-Panel </title>
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Kumar's  Hospital</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="logout.jsp"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a>
      </li>
       <li class="nav-item">
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action"   href="doctorView.jsp" role="tab" aria-controls="messages">View All Doctors</a>
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Add New Doctor</a>
       <a class="list-group-item list-group-item-action"   href="patientView.jsp" role="tab" aria-controls="settings">View All Patient Details!</a>
  ...
  <div class="col-md-8">
    <div class="tab-content" id="nav-tabContent">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="Appoinment">
                <div class="row">
      ...
      <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
        <div class="card">
          <div class="card-body">
            <form class="form-group" method="post" action="PaymentUpdate">
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="AddDoctor">
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.10.1/sweetalert2.all.min.js"></script>
	...
	<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9.17.2/dist/sweetalert2.all.min.js" integrity="sha256-KVC8P9Yoy4qMaxNn9mTjE1Om/57dmcPygxzlSGEKBbA=" crossorigin="anonymous"></script>
<script>
$(document).ready(function(){
	Swal.fire({
  title: 'WELCOME',
  text: 'Have a Great Day',
  imageUrl: 'images/js1.jpg',
  imageWidth: 400,
  imageHeight: 200,
