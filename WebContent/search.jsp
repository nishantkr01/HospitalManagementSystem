...
<%
	...
	PreparedStatement ps = cn.prepareStatement("select * from appointmenttb where contact=?");
...
%>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="deletePatient.jsp?contact=<%=rs.getString(4) %>" class='btn btn-secondary'>Delete</a></td>
    </tr>
    </tbody>
    <%
	}
    ...
    <a href="admin-panel.jsp" class="btn btn-primary col-4">Go Back</a>
<!-- Optional JavaScript -->
